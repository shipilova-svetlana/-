...
//
//*** И библиотеки "Heroeslib.h"
//
//***КПК по информатике 2021 год
//
...
void DrawSzenaNahalo()
    ...
    while (t <= 1200)
         ...
         DrawCar         (- t*2.15 + 1000,     350,                  1,                  1, RGB (255, 155, 1), 1);
...
void DrawSzenaOpozdanie()
    ...
    while (t <= 600)
         ...
         DrawMan         (             550, 950 - ROUND(t * 0.5),                1,                1, 1, ((t/2)%2)*5, 0,  0, 60, 0, ((t/2)%2)*30);
         DrawGirl        (       - t + 650,                  520,                2,                2, 0, 0, 0, 60, 0, ((t/2)%2)*30);
...
void StartTitles()
    ...
    while (t <= 85)
        ...
        txTextOut      (-705 + t * 10, 100, "Прогулка");
        txSelectFont   ("Gabriola", 200);
        txTextOut      (1505 - t * 15, 250, "летним днем");
...
void FinishTitles()
    ...
    while (t <= 85)
        ...
        txTextOut      (-705 + t * 12, 100, "Выполнила учитель информатики");
        txTextOut      (1495 - t * 14, 250, " Шипилова Светлана Львовна");
        txTextOut      (-705 + t * 12, 350, "Воронежская обл, 2021 год");
