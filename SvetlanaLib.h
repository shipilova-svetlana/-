...
//! Рисует струи дождя!
//!
//! @note                          Функция рисует дождь длинными прямыми линиями!
//!
//! @see                           DrawSzenaDojd()
//!
//! @par                           Пример использования:
...
//! Рисует куст
//!
//! @param x                      x - координата центра (окружостей из которых создан куст)
//! @param y                      y - координата центра (окружостей из которых создан куст)
...
//! @param sizex                  sizex - размер Кота по x
//! @param sizey                  sizey - размер Кота по y
//! @param COLORREF hbColor       Цвет Кота!
//! @param hvostx                 координата кончика хвоста (Кот может шевелить хвостом)
//! @param hvosty                 координата кончика хвоста (Кот может шевелить хвостом)
//! @param us                     координаты усов
//! @param lapax                  координаты лап
//! @param lapay                  координаты лап
//! @param uhoR                   координата кончика правого уха (Кот может шевелить ушами)
//! @param uhoL                   координата кончика левого уха (Кот может шевелить ушами)
...
//! @param rukaR                 движение правой руки
//! @param rukaL                 движение левой руки
//! @param nogaR                 движение правой ноги вверх-вниз
//! @param nogaL                 движение левой ноги вверх-вниз
//! @param rot                   Радиус рта Девочки
...
//! Рисует Машину
//!
//! @param x                     х-координата середины между колесами машины
//! @param y                     у-координата середины между колесами машины
...
//{---------------------------------------------------------------------------------------------------------
//! Рисует Мальчика Ивана
//!
//! @param x                     х-координата центра головы Мальчика
//! @param y                     у-координата центра головы Мальчика
...
//! Рисует дерево
//!
//! @param x                      x-координата верхней точки ствола дерева
//! @param y                      y-координата верхней точки ствола дерева
...
//{-------------------------------------------------------------------------------------------------------------
//! Рисует стрекозу заданного размера
//!
//! @param x                     x - координата центра головы стрекозы
//! @param y                     y - координата центра головы стрекозы
//! @param sizex                 sizex - размер стрекозы по x
//! @param sizey                 sizey - размер стрекозы по y
//! @param COLORREF heabColor    Цвет крыльев
//! @param COLORREF eyeColor     Цвет головы
//! @param COLORREF esColor      Цвет глаз
...
//!                              DrawPoletStrekoz()
//!                              DrawStrekoza (500, 50, 0.25, 0.25, TX_LIGHTMAGENTA, TX_GREEN, TX_LIGHTBLUE, 0.5, 3);
//! @endcode
//}---------------------------------------------------------------------------------------------------------------
...
//! Рисует елку
//!
//! @param x                     x - координата середины елки
//! @param y                     y - координата середины елки
...
//! Рисует ракету
//!
//! @param x                     x - координата середины ракеты
//! @param y                     y - координата середины ракеты
...
//{----------------------------------------------------------------------------------------------------------------
//! Рисует сцены из уже описанных объектов
//!
//! @param                     по умолчанию
//!
//! @par                       Пример использования:
...
//{----------------------------------------------------------------------------------------------------------------
//! Рисует динамические сцены из уже описанных объектов
//!
//! @param                   по умолчанию
//!
//! @par                     Пример использования:
